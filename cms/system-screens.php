...
switch ($action)
{
	...
	default:
		...
		$main_html['content'] = '<ul id="sortable">
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 1</option></select></li>
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 2</option></select></li>
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 3</option></select></li>
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 4</option></select></li>
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 5</option></select></li>
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 6</option></select></li>
  <li class="ui-state-default"><img src="/cms/images/file.png"><select><option value="">Item 7</option></select></li>
</ul>
 ';
		break;
